      ...
      <div class="modal-body">
        ...
        <div class="username-section">
          ...
          <input
            ...
            type="text"
            v-model="newUsername"
            :placeholder="currentUser?.name ? `${currentUser.name}` : 'Enter a new username'"
            :disabled="isUpdating"
          />
        </div>
        ...
        <div class="modal-actions">
          ...
          <button 
            @click="saveChanges" 
            class="save-button"
            :disabled="isUpdating || (!hasUsernameChanged && !selectedPhoto)"
          >
