<template>
  <div class="resizable-sidebar" ref="sidebar">
    ...
    <button class="new-conversation-button" @click="showModal = true">
      <img src="/assets/icons/new-conversation.png" alt="New Conversation" />
    </button>
...
const resizeSidebar = (event) => {
  if (isResizing && sidebar.value) {
    ...
    const newWidth = Math.max(200, Math.min(500, event.clientX - sidebarElement.getBoundingClientRect().left));
